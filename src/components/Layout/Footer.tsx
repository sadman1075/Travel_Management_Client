                    ...
                    <div >
                        <div className="flex justify-center  text-teal-600 sm:justify-start dark:text-teal-300">
                          <div className="flex items-center">
                              <svg className="h-8" viewBox="0 0 40 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        >
                            "Discover exciting destinations, customize your trips, and manage bookings with ease.
                            Enjoy a seamless journey from planning to exploring—all in one place!"
                        </p>
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-gray-700 dark:text-gray-300">01797506103</span>
                                    </a>
                                </li>
                                ...
                                >
                                    ...
                                    <address className="-mt-0.5 flex-1 text-gray-700 not-italic dark:text-gray-300">
                                        KA/84/3, Kuril Dhaka, Bangladesh
                                    </address>
                                </li>
                            </ul>
                        </div>
